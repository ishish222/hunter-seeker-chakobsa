...
A3:
    TracerRegisterReactions(self+0x3f475,ZeroWait1,0x0)
    TracerRegisterReactions(self+0x3f47d,FixWait1,0x0)
    TracerRegisterReactions(self+0x288d1,A4,0x0)
    TracerDebugContinueInf
    goto(decision)

A4:
    TracerRegisterReactions(EAX,ST,0x0)
    TracerRegisterReactions(EAX+0x35,flip2,0x105)
    TracerRegisterReactions(EAX+0x59,flip3,0x105)
    TracerDebugContinueInf
    goto(decision)
