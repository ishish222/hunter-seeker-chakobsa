...
p2_t1_v2_b:
    ...
    TracerRegisterReactions(self+0x36bdb,ST,0x0)
    TracerRegisterReactions(self+0x36bdd,flip_1,0x105)
    TracerRegisterReactions(self+0x36c0b,flip_2,0x105)
    TracerRegisterReactions(self+0x5f449,flip_3,0x105)
