...
A4:
    ...
    TracerRegisterReactionsAt(set_priority,0x0)
    EnableReaction(set_priority)

    LoadEP
    Adjust(0x524e)
    Push

    TracerRegisterReactionsAt(zero_wait,0x0)
    EnableReaction(zero_wait)
    ...
    TracerRegisterReactionsAt(suspend,0x0)
    EnableReaction(zero_wait)
    ...
    TracerRegisterReactionsAt(ST,0x0)
    EnableReaction(ST)
