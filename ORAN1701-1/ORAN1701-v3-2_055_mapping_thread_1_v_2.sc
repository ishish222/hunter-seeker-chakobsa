...
Main:
    ...
    # RR
    ExtractEP(\\10.0.2.4\qemu\samples\shared\sample_869d.exe) 
    #SaveEP 
    #ManualSTwSelf 
...
A5:
    ...
    TracerRegisterReactions(self+0x54d72,flip9,0x103)
    AutorepeatReaction(flip9)

    TracerRegisterReactions(self+0x36a17,flip10,0x103)
...
#    TracerRegisterReactions(self+0x4e203,ST,0x0)
    TracerRegisterReactions(self+0x54e38,ST,0x0)
...
#    ReadArg(0xa)
#    CheckEqual(0x0044e173)=(N:decision)

    DisableReaction(flip5)
    DisableReaction(flip6)
    DisableReaction(flip7)
    DisableReaction(flip10)
    DisableReaction(read_from_reg_1_flip_1)
