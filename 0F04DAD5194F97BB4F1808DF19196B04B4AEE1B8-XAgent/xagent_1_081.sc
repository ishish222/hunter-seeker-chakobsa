# intervention in CC command parsing - additional flags after checksum, selected command id - 0x28, another intervention
...
TracerRegisterReactions(netapi64.dll+0x6815,flip8,0x105)
EnableReaction(flip8)
AutorepeatReaction(flip8)

TracerRegisterReactions(netapi64.dll+0x684d,flip9,0x105)
EnableReaction(flip9)
AutorepeatReaction(flip9)

TracerRegisterReactions(netapi64.dll+0x2b6b,flip10,0x105)
EnableReaction(flip10)
AutorepeatReaction(flip10)

TracerRegisterReactions(netapi64.dll+0x27ed,flip11,0x105)
EnableReaction(flip11)
AutorepeatReaction(flip11)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_043)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_043)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_043)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_043)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_043)
    QemuQuit
