# based on xagent_1_006, exploring cmd_unknown::vcall_2_large
...
TracerRegisterReactions(netapi64.dl+0x6fa3,flip3,0x105)
TracerRegisterReactions(netapi64.dll+0x4630,ST,0x0)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_033)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_033)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_033)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_033)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_033)
    QemuQuit
