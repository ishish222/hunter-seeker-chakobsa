...
# RR
# od poczatku liba
TracerRegisterReactions(netapi64.dll+0x110b0,ST,0x0)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_010)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_010)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_010)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_010)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_010)
    QemuQuit
