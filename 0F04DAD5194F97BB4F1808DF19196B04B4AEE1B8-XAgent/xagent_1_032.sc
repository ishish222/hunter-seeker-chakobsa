# recording again, from receiving to parsing
...
TracerRegisterReactions(netapi64.dll+0x28d1,ST,0x0)
EnableReaction(ST)
...
TracerRegisterReactions(netapi64.dll+0x3914,flip6,0x105)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_032)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_032)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_032)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_032)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_032)
    QemuQuit
