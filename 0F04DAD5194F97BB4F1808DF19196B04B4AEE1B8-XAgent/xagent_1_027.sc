# intervention in CC command parsing - additional flags after checksum, selected command id - 0x29
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_027)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_027)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_027)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_027)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_027)
    QemuQuit
