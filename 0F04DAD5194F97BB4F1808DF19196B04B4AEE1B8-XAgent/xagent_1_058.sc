# exploring mailslot functionality - exploring engine_mailslot_handler::unknown_1
...
TracerRegisterReactions(netapi64.dll+0xac74,flip5,0x105)
...
exception:
Interrupt
RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_058)
RunCmd(copy e:\server\log_0.txt \\10.0.2.4\qemu\logs\xagent_1_058)
RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_058)
QemuQuit
