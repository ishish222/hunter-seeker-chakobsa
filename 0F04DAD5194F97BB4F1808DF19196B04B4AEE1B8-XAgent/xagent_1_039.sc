# based on xagent_1_006, exploring cmd_mailslot::vcall_2
...
TracerRegisterReactions(netapi64.dl+0xc195,flip3:flip4,0x105)
TracerRegisterReactions(netapi64.dl+0xbc91,flip4:flip5,0x105)
TracerRegisterReactions(netapi64.dl+0xbce8,flip5,0x105)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_039)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_039)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_039)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_039)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_039)
    QemuQuit
