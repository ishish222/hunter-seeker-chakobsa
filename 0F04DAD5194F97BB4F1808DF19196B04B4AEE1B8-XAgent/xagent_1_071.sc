# intervention in CC command parsing - exploring egine_sleeping commands parsing - cmd 0x0, trying to make subsequent command 0x1
...
# RR
# od poczatku liba
TracerRegisterReactions(netapi64.dll+0xdf1c,ST,0x0)
...
TracerRegisterReactions(netapi64.dll+0x66b8,select_command,0x0)
#EnableReaction(select_command)
#AutorepeatReaction(select_command)

TracerRegisterReactions(netapi64.dll+0xdea6,select_command_2,0x0)
EnableReaction(select_command_2)
AutorepeatReaction(select_command_2)
...
TracerRegisterReactions(netapi64.dll+0x6a14,flip8,0x105)
EnableReaction(flip8)
AutorepeatReaction(flip8)

TracerRegisterReactions(netapi64.dll+0xdef2,flip9,0x105)
EnableReaction(flip9)
...
Decision=(
    ...
    select_command_2:select_command_2,
    default:loop
)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_070)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_070)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_070)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_070)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_070)
    QemuQuit
