...
# RR
# od poczatku liba
TracerRegisterReactions(netapi64.dll+0x9880,ST,0x0)
# niedlugo przed pobieraniem
#TracerRegisterReactions(self+28e5,ST,0x0)
EnableReaction(ST)

TracerRegisterReactions(netapi64.dll+0x98f1,flip1,0x105)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_019)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_019)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_019)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_019)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_019)
    QemuQuit
