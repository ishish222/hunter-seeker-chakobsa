# like 15, path e29, only next branch 1 
...
# RR
# od poczatku liba
TracerRegisterReactions(netapi64.dll+0x1080,ST,0x0)
# niedlugo przed pobieraniem
#TracerRegisterReactions(self+28e5,ST,0x0)
EnableReaction(ST)

TracerRegisterReactions(netapi64.dll+0x1d28,flip1,0x108)
EnableReaction(flip1)
AutorepeatReaction(flip1)

TracerRegisterReactions(netapi64.dll+0x1e3b,flip2,0x103)
EnableReaction(flip2)
AutorepeatReaction(flip2)

TracerRegisterReactions(netapi64.dll+0x1e66,flip3,0x103)
EnableReaction(flip3)
AutorepeatReaction(flip3)

TracerRegisterReactions(netapi64.dll+0x1e9a,flip4,0x103)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/xagent_1_017)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\xagent_1_017)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\xagent_1_017)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\xagent_1_017)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\xagent_1_017)
    QemuQuit
