...
Main:
    ...
    Main_Copy:
#        RunCommand(copy \\10.0.2.4\qemu\input\origin05.xar c:\users\john\desktop\sample.xar)
#        RunCommand(copy \\10.0.2.4\qemu\input\origin05_tmp0ei41lsf.xar c:\users\john\desktop\sample.xar)
        RunCommand(copy \\10.0.2.4\qemu\input\origin_11_tmp0fcll73k.xar c:\users\john\desktop\sample.xar)
