...
Main:
    ...
    Main_Copy:
        ...
        #RunCommand(copy /Y \\10.0.2.4\qemu\input c:\users\john\desktop\)
        # moze samo kopiowanie uderza?
        CheckStrStr(cannot)=(Y:Main_Sleep)
        CheckStrStr(network)=(Y:Main_Sleep)

    # zgodne z bibliotekami na rzut_2
...
RE:
    ...
    CheckStrStr(0x000006ba)=(Y:RE_continue)
