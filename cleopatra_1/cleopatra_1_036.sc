...
TracerRegisterReactions(self+0x35f7,ST,0x0)
EnableReaction(ST)
TracerPrev
TracerDebugContinueInf
TracerNext
...
Start:
    EnableBuiltin
    TracerRegisterReactions(self+0xd993,flip3,0x105)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_036)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_036)
    RunCmd(copy e:\server\log_0.txt \\10.0.2.4\qemu\logs\cleopatra_1_036)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_036)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_036)
    QemuQuit
