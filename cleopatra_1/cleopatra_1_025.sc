...
TracerRegisterReactions(self+0x3c01,flip4:flip6,0x102)
#TracerRegisterReactions(self+0x3c19,flip5,0x102)
TracerRegisterReactions(self+0x3d64,flip6,0x0:0x102)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_025)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_025)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\cleopatra_1_025)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_025)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_025)
    QemuQuit
