# Trying to load response from file & update after decoding
...
#TracerRegisterReactions(self+0x6954,A1:ST,0x0;[ESP+0x8]+0xb3,ST,0x0)
TracerRegisterReactions(self+0x6954,A1,0x0)
EnableReaction(A1)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_043)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_043)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\cleopatra_1_043)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_043)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_043)
    QemuQuit
