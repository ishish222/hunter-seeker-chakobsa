...
TracerRegisterReactions(self+0x3c01,flip4:flip5,0x102)
TracerRegisterReactions(self+0x4a5d,flip5:flip6,0x0:0x102)
...
create1:
    ...
    RunRoutine(0x201)
    TracerRegisterReactions([ESP+0x8]+0x5d,ST,0x0)
    EnableReaction(ST)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_028)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_028)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\cleopatra_1_028)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_028)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_028)
    QemuQuit
