# Recording after CreateRemoteThread
# first ST includes long loop for encoding bot i guess
...
Enqueue(Test2)
Enqueue(Test1)
Enqueue(file:calc.exe)
Enqueue(someshit_123)
...
TracerRegisterReactions(self+0x84f9,flip8,0x102)
EnableReaction(filp8)
TracerRegisterReactions(self+0x8565,flip9,0x105)
EnableReaction(filp9)
TracerRegisterReactions(self+0x8594,flip10,0x105)
EnableReaction(filp10)
TracerRegisterReactions(self+0x860e,flip11,0x105)
EnableReaction(filp11)
TracerRegisterReactions(self+0x8926,FFF,0x0)
EnableReaction(FFF)

TracerRegisterReactions(self+0x850d,ST,0x0)

#TracerRegisterReactions(self+0x69b9,ST,0x0)
EnableReaction(ST)

TracerRegisterReactions(self+0x6972,mod3,0x0)
EnableReaction(mod3)
...
TracerRegisterReactions(self+0x3b0e,HANDLE_RECEIVED,0x0)
EnableReaction(HANDLE_RECEIVED)
AutorepeatReaction(HANDLE_RECEIVED)


TracerRegisterReactions(self+0x3669,NEXT1,0x0)
TracerRegisterReactions(self+0x3b01,NEXT2,0x0)
TracerRegisterReactions(self+0x3b54,NEXT3,0x0)
EnableReaction(NEXT1)
EnableReaction(NEXT2)
EnableReaction(NEXT3)
...
TracerRegisterReactions(self+0x3d64,flip6,0x102)
EnableReaction(filp6)

TracerRegisterReactions(self+0x1e86,flip7,0x102)
...
a1:
    ReadStack
#    TracerRegisterReactions([ESP+0x8]+0xb3,ST,0x0)
#    EnableReaction(ST)
    TracerDebugContinueInf
    goto(decision)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_048)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_048)
    RunCmd(copy e:\server\log_*.txt \\10.0.2.4\qemu\logs\cleopatra_1_048)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_048)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_048)
    QemuQuit
