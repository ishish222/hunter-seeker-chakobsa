...
TracerRegisterReactions(self+0x380b,ST,0x0)
EnableReaction(ST)
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_039)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_039)
    RunCmd(copy e:\server\log_txt \\10.0.2.4\qemu\logs\cleopatra_1_039)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_039)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_039)
    QemuQuit
