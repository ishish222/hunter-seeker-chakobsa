...
GetOptions
GetSampleOptions
SetSampleFile(arab_560000_mod2.exe)
SetResearchDir(e:\samples\shared)
GlobPattern(/home/hs1/malware_samples/arab_560000_mod2.exe)
...
# RR
#ExtractEP(e:\samples\shared\arab_560000_mod2.exe)
#SaveEP
#ManualSTwSelf
...
exception:
    Interrupt
    RunCmdHost(mkdir -p /mnt/1/output/logs/cleopatra_1_015)
    RunCmd(copy e:\logs\responder_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_015)
    RunCmd(copy e:\server\log_0.txt \\10.0.2.4\qemu\logs\cleopatra_1_015)
    RunCmd(copy e:\logs\init_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_015)
    RunCmd(copy e:\logs\last_log.txt \\10.0.2.4\qemu\logs\cleopatra_1_015)
    QemuQuit
