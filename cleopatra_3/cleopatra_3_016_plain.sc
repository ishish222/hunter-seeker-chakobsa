...
Start:
    ...
    Push2(Test2)
    Push2(Test1)
    Push2(kjhsadlfkjhsaldfkhaslkdfjhlksajfhlksajdhflkasjhflkasjhdflkasjhdflkashjfdlkjasdhflkashjfdlkjashdflkashjdfkljhasdflkjhasdlfkjhasflkjhasdlkfjhalskfdjhest9aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa)
    Push2(kjhsadlfkjhsaldfkhaslkdfjhlksajfhlksajdhflkasjhflkasjhdflkasjhdflkashjfdlkjasdhflkashjfdlkjashdflkashjdfkljhasdflkjhasdlfkjhasflkjhasdlkfjhalskfdjhest9aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa)
...
RESUMETHREAD:
    ...
    LoadEP
    #ManualST
    TracerRegisterReactions(0x40699f,ST2,0x0)
    ...
    #TracerRegisterReactions(0x40699a,flip6,0x106)
    TracerRegisterReactions(0x402436,set_esi,0x0)
    TracerRegisterReactions(0x406991,set_plaintext,0x0)
#    TracerRegisterReactions(0x401e1d,update_read_1,0x0)
    ResumeThread
